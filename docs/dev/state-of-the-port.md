...
**R3 is feature-complete, and R4's first six slices have landed.** `crates/journal`
...
field of a record editable through one verb**, and **undo/redo**. The phase list and each slice's notes are in
