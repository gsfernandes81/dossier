...
> setup), minus everything Docker/Makefile/Railway/Atlas/DB/Discord-specific, which does
> not apply here.
...
- There is **no Makefile** (deliberately — mirrored-out). Use the `uv run` commands above.
